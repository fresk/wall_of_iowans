...
# from museum import Viewport, ListItem, ListLayout
...
#     photo_group = ObjectProperty()



# class PhotoButton(ListItem):
...
#         print "selected", self.data['title']

# class PhotoGroup(F.ListLayout):
#     item_class = PhotoButton
...
#         def done(*args):
#             p = self.parent
#             p.add_widget(GridScreen(items=DB))
...
#         self.viewport.add_widget(OverviewScreen())
#         #return OverviewScreen(items=DB)
